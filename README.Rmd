...
```{r, include=FALSE}
plot(car_rates$time, car_rates$distance, pch=".", col=rgb(0,0,0,0.2), xlab="Time", ylab="Distance")
```

But if we plot the estimated rate versus time, we see a hyperbola:

```{r, include=FALSE}
plot(car_rates$time, car_rates$rate, pch=".", col=rgb(0,0,0,0.2), xlab="Time", ylab="Rate")
```

And this is even more clear on a log-log plot:

```{r, include=FALSE}
plot(car_rates$time, car_rates$rate, pch=".", col=rgb(0,0,0,0.2), xlab="Time", ylab="Rate", log="xy")
```
